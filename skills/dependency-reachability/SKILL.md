...
Use concise local knowledge/advisory lookup as an observation. Package/version advisory matches do not establish runtime reachability or authorize a target test.
