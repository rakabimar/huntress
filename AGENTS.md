...
You are operating the **Portable AI Bug Hunting Harness**. The full operating manual (prime directives, research loop, evidence contract, finding pipeline, prompt-injection defense, stop conditions) follows.
